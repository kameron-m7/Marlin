 ...
 */
#define USE_CONTROLLER_FAN																																	//Enabled
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN PC7           // Set a custom pin for the controller fan																		//Enabled, Changed from -1
  ...
  #define CONTROLLER_FAN_EDITABLE         // Enable M710 configurable settings																				//Enabled
...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first																		//Enabled
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 500																																//Enabled
...
#define SLOWDOWN
#if ENABLED(SLOWDOWN)
  #define SLOWDOWN_DIVISOR 8																														//Changed from 2
#endif
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING																													//Enabled
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu																				//Enabled
  ...
  #define LCD_SET_PROGRESS_MANUALLY																													//Enabled
...
// LCD Print Progress options
    ...
    #define SHOW_REMAINING_TIME         // Display estimated time to completion																			//Enabled
    #if ENABLED(SHOW_REMAINING_TIME)
      #define USE_M73_REMAINING_TIME    // Use remaining time from M73 command instead of estimation													//Enabled
      #define ROTATE_PROGRESS_DISPLAY   // Display (P)rogress, (E)lapsed, and (R)emaining time															//Enabled
    #endif
  #endif

  #if EITHER(HAS_MARLINUI_U8GLIB, EXTENSIBLE_UI)
    #define PRINT_PROGRESS_SHOW_DECIMALS // Show progress with decimal digits																			//Enabled
  #endif
  ...
  #define BROWSE_MEDIA_ON_INSERT          // Open the file browser when media is inserted																				//Enabled
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'					//Enabled
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol

  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu																		//Enabled
   ...
   */
  #define SDCARD_CONNECTION ONBOARD																												//Enabled, Changed from LCD

  // Enable if SD detect is rendered useless (e.g., by using an SD extender)
  #define NO_SD_DETECT																														//need this
 ...
 */
  ...
  #define STATUS_HEAT_PERCENT       // Show heating in a progress bar																			//Enabled
...
#define BABYSTEPPING																																			//Enabled
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping																					//Enabled
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // Enable graphical overlay on Z-offset editor															//Enabled
  #endif
#endif
 ...
 */
#define LIN_ADVANCE																																		//Enabled
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  #define LIN_ADVANCE_K 0.00    // Unit: mm compression per 1mm/s extruder speed																		//Changed from 0.22, needs update
 ...
 */
#define EMERGENCY_PARSER																																//Enabled
...
#define ADVANCED_PAUSE_FEATURE																														//Enabled
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      500  // (mm) The length of filament for a complete unload.																//Changed from 100
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     0  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  #define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.														//Enabled
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change.																	//Enabled
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       580        // (mA) RMS current. Multiply by 1.414 for peak current.																	//Changed from 800
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       580																																	//Changed from 800
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       580																																	//Changed from 800
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      350																												//Changed from 800
    #define E0_MICROSTEPS    16
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below)																					//Changed from 12V
   ...
   */
  #define HYBRID_THRESHOLD																																		//Enabled
   ...
   */
  #define SQUARE_WAVE_STEPPING																														//Enabled
